...
public class Parser {
    ...
    /**
     * Parses the given list of tokens into an abstract syntax tree using the
     * parsing table generated by the grammar rules.
     *
    ...
    /**
     * Builds a parsing table from the grammar rules.
     *
     * @return A table mapping each non-terminal to a map of token types to productions.
     */
